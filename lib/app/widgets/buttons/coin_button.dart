...
import 'package:flutter_application_3/app/widgets/buttons/gradient_circular_progress_indicator.dart';

/// Enum representing the possible states of [CoinButton]
enum StateButton {
  /// Normal active state
  success,
...
class CoinButton extends StatelessWidget {
  ...
  factory CoinButton.outlinedSquare({
    Key? key,
  ...
  /// - [height]: Button height (defaults to 48)
  /// - [icon]: Optional icon to display
  factory CoinButton.outlinedRounded({
    Key? key,
    required String label,
    required VoidCallback onPressed,
    StateButton state = StateButton.success,
  ...
  /// - [height]: Button height (defaults to 48)
  /// - [icon]: Optional icon to display
  factory CoinButton.smallRounded({
    Key? key,
    required String label,
    required VoidCallback onPressed,
    StateButton state = StateButton.success,
  ...
  /// - [height]: Button height (defaults to 48)
  /// - [icon]: Optional icon to display
  factory CoinButton.smallSquare({
    Key? key,
    required String label,
    required VoidCallback onPressed,
    StateButton state = StateButton.success,
